# -*- coding: utf-8 -*-
# Generated by Django 1.11.26 on 2019-11-13 12:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.CharField(blank=True, help_text='如果设置的不是HTML类型，可为空', max_length=600, verbose_name='内容')),
                ('status', models.PositiveIntegerField(choices=[(1, '隐藏'), (0, '显示')], default=0, verbose_name='状态')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='作者')),
            ],
            options={
